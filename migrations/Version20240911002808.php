 ...
 */
final class Version20240911002808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE is_homepage is_homepage TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE is_homepage is_homepage TINYINT(1) NOT NULL');
    }
}
